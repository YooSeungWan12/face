...
file = 'C:\\Users\\asiae\\Documents\\Bandicam\\video.mp4'
try:
    video = cv2.VideoCapture(file) #웹캠을사용
    video.set(3,1080) #너비
    video.set(4,800) #높이 지정
except:
    print("파일 연결실패")



while(video.isOpened()): #열려있는동안만
